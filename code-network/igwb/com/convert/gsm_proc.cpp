...
CGSMChannel::CGSMChannel() : CProcChannel()
{

}

CGSMChannel::~CGSMChannel()
{
...
抛出异常    无
**********************************************************************/
void CGSMChannel::ProcessSerialNo(SBill*& pABill)
{
...
抛出异常    无
**********************************************************************/
BOOL CGSMChannel::ConvertABill(SBill* pABill, SBill* pConvertedBill, 
                               CFormat* pDestFmt)
{
...
抛出异常    无
**********************************************************************/
BOOL CBPGSM::Init(UINT4 uAPID, BOOL bNeedConvert, BOOL bNeedMerge)
{
    ...
    {
        m_ChannelArray[nChannelNo] = new CGSMChannel();
...
抛出异常    无
**********************************************************************/
BOOL CBPGSM::PreProcess(BYTE*& pBills, UINT4 &uLeftLen, SBill* pABill)
{
