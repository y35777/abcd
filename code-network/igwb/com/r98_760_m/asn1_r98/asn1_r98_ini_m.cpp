#include "CDRF_2GCDR_Org_M.h"

/******************************************************
* 函数名:   DeCodeGPRSBill_ini_M_mt
* 作者:    Zhou Yonghui
* 日期:    01-10-8
* 描述:
* 输入:
                                           ...
                                           /* 并返回编码结果的长度 (in,out) */
{
    ...
    int nErr = 0;
    if(nErr = ossEncode(world, Org_M_BSRecord_PDU,(void*)pVal,
        &encodedData))
    {
...
void* Init_OSS_Lib_Ini_M()
{
    ...
    */
    ...
    if(ossinit(world, CDRF_2GCDR_Org_M))
    {
        delete world;
        return NULL;
    }
