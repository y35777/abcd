#include "CDRF_CMCC_3GCDR_CG_M.h"

/******************************************************
* 函数名:  DeCode3GBill_final_M_mt
* 作者:    maimaoshi
* 日期:    02-12-13
                          ...
                          int nBufLen)    /* 缓冲区的长度 */
{
    ...
    int pdu = CMCC_3GCDR_CG_M_BSRecord_PDU;
                                             ...
                                             /* 并返回编码结果的长度 (in,out) */
{
    ...
    int nErr = 0;
    if(nErr = ossEncode(world, CMCC_3GCDR_CG_M_BSRecord_PDU,(void*)pVal,
        &encodedData))
    {
		return NULL;
    }
...
void* Init_OSS_Lib_Final_M()
{
    ...
    */
    ...
    if(ossinit(world, CMCC_CDRF_R99_Fin_M))
    {
        delete world;
        return NULL;
    }
