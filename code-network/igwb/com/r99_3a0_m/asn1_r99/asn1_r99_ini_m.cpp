                        ...
                        int nBufLen)    /* 缓冲区的长度 */
{
    ...
    int pdu = CMCC_3GCDR_M_BSRecord_PDU;
                                           ...
                                           /* 并返回编码结果的长度 (in,out) */
{
    ...
    int nErr = 0;
    if(nErr = ossEncode(world, CMCC_3GCDR_M_BSRecord_PDU,(void*)pVal,
        &encodedData))
    { 
		return NULL;
    }
...
void* Init_OSS_Lib_Ini_M()
{
    ...
    */
    ...
    if(ossinit(world, CMCC_CDRF_R99_Org_M))
    {
        delete world;
        return NULL;
    }
