...
// Description:  The Head File of the CFormatR98
//      Author:  maimaoshi
//        Date:  2002.04.03
...
/****************** The CFormatR98 class Defining ********************/
// 功能描述：Gprs话单格式类
//
/********************************************************************/
class CFormatR98: public CFormat
{
public:

    //构造函数
    CFormatR98(const STRING& sRootDir, const STRING& sFmtName);
