...
/* Abstract syntax: CDRF_R98_Org */
/* Created: Fri Dec 19 10:59:16 2003 */
 ...
 * D:\yutemp\lidufang\1218\R98\r98_org\CDRF_R98_Org.asn
 */
...
void DLL_ENTRY_FDEF _ossinit_CDRF_R98_Org(struct ossGlobal *world) {
...
#endif
static int DLL_ENTRY _emCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_inbuf, char **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH]);
static int DLL_ENTRY _dmCDRF_R98(struct ossGlobal *_g, int *_pdunum, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH]);
static int DLL_ENTRY _fmCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl);
#ifdef OSSPRINT
int DLL_ENTRY _pmCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl);
#endif
...
static const _Context_Id _context_id[] = {
    ...
    {"Org_sgsnPLMNIdentifier", "PLMN-Id", _octetstring_type},
...
static int _eOrg_CallEventRecord(struct ossGlobal *_g, void *_inbuf, char **_outbuf, long *_outlen, unsigned _flags)
{
	...
	case 2:
		...
		if (_in_data->u.ggsnPDPRecord.bit_mask & Org_sgsnPLMNIdentifier_present) {
...
static int DLL_ENTRY_FDEF _emCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_inbuf, char **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    _EncDecGlobals *_oss_c = (_EncDecGlobals*)_g->encDecVar;
    int _rc = 0;
	...
	default:
		...
		_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
		{
			...
			default:
				...
				if (_out_data->u.ggsnPDPRecord.bit_mask & Org_sgsnPLMNIdentifier_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
				_out_data->u.ggsnPDPRecord.bit_mask |= Org_sgsnPLMNIdentifier_present;
				_oss_c->_tag_decoded = FALSE;
				_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
...
static int DLL_ENTRY_FDEF _dmCDRF_R98(struct ossGlobal *_g, int *_pdunum, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    _EncDecGlobals *_oss_c = (_EncDecGlobals*)_g->encDecVar;
    int _rc = 0;
...
static int _fOrg_CallEventRecord(struct ossGlobal *_g, void *_data)
{
	...
	if (_data_ptr->u.ggsnPDPRecord.bit_mask & Org_sgsnPLMNIdentifier_present) {
	}
...
static int DLL_ENTRY_FDEF _fmCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl)
{
    int _rc = 0;
...
int DLL_ENTRY_FDEF _pmCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl)
{
    int _rc = 0;
...
/* Entry points */
static const _entry_point_struct _entry_points = {_ossinit_CDRF_R98_Org, _emCDRF_R98, _dmCDRF_R98, _fmCDRF_R98, 16,
 NULL, NULL, 0, 0, NULL
#ifdef OSSPRINT
, _pmCDRF_R98
#endif
...
static void _oss_post_init(struct ossGlobal *world) {
    static const unsigned char _oss_typeinfo[] = {
        0x00, 0x7a, 0x33, 0xd8, 0x3d, 0xf2, 0xb3, 0x45, 0xdf, 0x04,
        0x92, 0x47, 0xdf, 0x07, 0x92, 0x70, 0xb4, 0xe1, 0x79, 0xfc,
        0x88, 0xd5, 0x7a, 0x32, 0x0d, 0x10, 0xb6, 0x68, 0x50, 0x23,
        0xcf, 0x1f, 0xcd, 0x73, 0xab, 0x06, 0x6f, 0x55, 0x01, 0x72,
        0xb8, 0xaa, 0x87, 0xd0, 0xc0, 0x66, 0xcf, 0xc9, 0x06, 0x22,
        0x8b, 0x77, 0x1e, 0xa9, 0x09, 0xd5, 0x3c, 0x5b, 0x2a, 0x7d,
        0x66, 0x73, 0x12, 0xf2, 0x66, 0xd3, 0xa6, 0x5a, 0x79, 0x9d,
        0xa7, 0xff, 0x5b, 0x16, 0x34, 0xa8, 0x17, 0x3e, 0x29, 0xac,
        0xc4, 0xad, 0x39, 0x5c, 0x19, 0xa6, 0x75, 0x98, 0x3b, 0x4c,
        0x08, 0x0b, 0xaf, 0x5e, 0x69, 0x8d, 0x8e, 0x8d, 0x54, 0x29,
        0x8d, 0x51, 0xec, 0x92, 0x32, 0x0a, 0x48, 0x4d, 0x62, 0x16,
        0x29, 0x03, 0x1f, 0x0a, 0xa9, 0xd7, 0x7a, 0x54, 0x0e, 0x10,
        0xed, 0x82, 0x05, 0xdc
    };
...
void *CDRF_R98_Org = (void *)&_entry_points;
