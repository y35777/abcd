...
#ifndef OSS_CDRF_R98_Fin
#define OSS_CDRF_R98_Fin
...
#       define      Fin_sgsnPLMNIdentifier_present 0x0080
#       define      Fin_GGSNPDPRecord_servedMSISDN_present 0x0040
    Fin_CallEventRecordType recordType;
    Fin_NetworkInitiatedPDPContext networkInitiation;  /* optional; set in
                                   * bit_mask
    ...
    Fin_APNSelectionMode apnSelectionMode;  /* optional; set in bit_mask
                                ...
                                * present */
    Fin_PLMN_Id     sgsnPLMNIdentifier;  /* optional; set in bit_mask
                                          * Fin_sgsnPLMNIdentifier_present if
                                          * present */
    Fin_MSISDN      servedMSISDN;  /* optional; set in bit_mask
...
#       define      Fin_significance_present 0x80
    ...
    struct Fin__octet3 information;
...
extern void *CDRF_R98_Fin;    /* encoder-decoder control table */
#ifdef __cplusplus
}	/* extern "C" */
#endif /* __cplusplus */
#endif /* OSS_CDRF_R98_Fin */
