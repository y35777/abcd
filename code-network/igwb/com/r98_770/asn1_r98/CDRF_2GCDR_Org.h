...
#ifndef OSS_CDRF_R98_Org
#define OSS_CDRF_R98_Org
...
#       define      Org_significance_present 0x80
    ...
    struct Org__octet3 information;
...
#       define      Org_sgsnPLMNIdentifier_present 0x0020
#       define      Org_GGSNPDPRecord_servedMSISDN_present 0x0010
    Org_CallEventRecordType recordType;
    Org_NetworkInitiatedPDPContext networkInitiation;  /* optional; set in
                                   * bit_mask
    ...
    Org_APNSelectionMode apnSelectionMode;  /* optional; set in bit_mask
                                ...
                                * present */
    Org_PLMN_Id     sgsnPLMNIdentifier;  /* optional; set in bit_mask
                                          * Org_sgsnPLMNIdentifier_present if
                                          * present */
    Org_MSISDN      servedMSISDN;  /* optional; set in bit_mask
...
extern void *CDRF_R98_Org;    /* encoder-decoder control table */
#ifdef __cplusplus
}	/* extern "C" */
#endif /* __cplusplus */
#endif /* OSS_CDRF_R98_Org */
