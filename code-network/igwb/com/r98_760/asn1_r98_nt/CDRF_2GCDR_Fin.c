...
void DLL_ENTRY_FDEF _ossinit_CDRF_2GCDR_Fin(struct ossGlobal *world) {
...
#endif
static int DLL_ENTRY _emCDR2G(struct ossGlobal *_g, int _pdunum, void *_inbuf, char **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH]);
static int DLL_ENTRY _dmCDR2G(struct ossGlobal *_g, int *_pdunum, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH]);
static int DLL_ENTRY _fmCDR2G(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl);
#ifdef OSSPRINT
int DLL_ENTRY _pmCDR2G(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl);
#endif
...
static int DLL_ENTRY_FDEF _emCDR2G(struct ossGlobal *_g, int _pdunum, void *_inbuf, char **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    _EncDecGlobals *_oss_c = (_EncDecGlobals*)_g->encDecVar;
    int _rc = 0;
...
static int DLL_ENTRY_FDEF _dmCDR2G(struct ossGlobal *_g, int *_pdunum, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    _EncDecGlobals *_oss_c = (_EncDecGlobals*)_g->encDecVar;
    int _rc = 0;
...
static int DLL_ENTRY_FDEF _fmCDR2G(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl)
{
    int _rc = 0;
...
int DLL_ENTRY_FDEF _pmCDR2G(struct ossGlobal *_g, int _pdunum, void *_data, void *_ctl_tbl)
{
    int _rc = 0;
...
/* Entry points */
static const _entry_point_struct _entry_points = {_ossinit_CDRF_2GCDR_Fin, _emCDR2G, _dmCDR2G, _fmCDR2G, 16,
 NULL, NULL, 0, 0, NULL
#ifdef OSSPRINT
, _pmCDR2G
#endif
...
static void _oss_post_init(struct ossGlobal *world) {
    static const unsigned char _oss_typeinfo[] = {
        0x00, 0x78, 0x33, 0xb0, 0xff, 0x8a, 0x51, 0x2d, 0x1d, 0x7c,
        0x70, 0x2f, 0x1d, 0x7f, 0x70, 0x8b, 0x1c, 0xf8, 0x22, 0x73,
        0xf9, 0x32, 0xbe, 0x65, 0x95, 0x50, 0x2b, 0x04, 0xee, 0x36,
        0x6c, 0xc7, 0x43, 0x2f, 0xac, 0x64, 0x0d, 0x57, 0x3d, 0x05,
        0x24, 0x15, 0xd0, 0x78, 0x19, 0xc4, 0x47, 0x36, 0x2b, 0x6c,
        0x12, 0xb3, 0x03, 0x2d, 0xdb, 0x05, 0x15, 0x3e, 0xe1, 0x88,
        0x0a, 0xbb, 0x38, 0xca, 0x90, 0x4f, 0xd5, 0x3a, 0xe6, 0x47,
        0x84, 0x19, 0xdc, 0x96, 0xe9, 0xc2, 0xee, 0xca, 0x61, 0x42,
        0x32, 0x5a, 0x1c, 0x39, 0x75, 0xcd, 0x30, 0xf0, 0x74, 0x98,
        0x01, 0xde, 0x0f, 0xa2, 0x65, 0xe9, 0xd4, 0x57, 0x1c, 0xab,
        0x82, 0x73, 0x73, 0x62, 0xb0, 0xb1, 0xa8, 0xed, 0x81, 0x1a,
        0x44, 0x85, 0xd8, 0x30, 0xbe, 0x03, 0x96, 0x50, 0x03, 0xc8,
        0x74, 0x5e
    };
...
void *CDRF_2GCDR_Fin = (void *)&_entry_points;
