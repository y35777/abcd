...
#include "CDRF_2GCDR_Fin.h"
#include "../../include/export_dll.h"

/******************************************************
* 函数名:  DeCodeGPRSBill_final
* 作者:    Zhou Yonghui
* 日期:    01-6-1
                        ...
                        int nBufLen)    /* 缓冲区的长度 */
{
    ...
    int pdu = Fin_CallEventRecord_PDU;
                                           ...
                                           /* 并返回编码结果的长度 (in,out) */
{
    ...
    int nErr = 0;
    if(nErr = ossEncode(world, Fin_CallEventRecord_PDU,(void*)pVal,
        &encodedData))
    {
...
void* Init_OSS_Lib_Final()
{
    ...
    */
    ...
    if(ossinit(world, CDRF_2GCDR_Fin))
    {
        delete world;
        return NULL;
    }
