...
/* Abstract syntax: CDRF_R98_Org_M */
/* Created: Fri Dec 19 10:59:33 2003 */
 ...
 * D:\yutemp\lidufang\1218\R98\r98_org_m\CDRF_R98_Org_M.asn
 */
...
static void _ossinit_CDRF_R98_Org_M(struct ossGlobal *world) {
    _oss_run_TOED_on_SPARC_SOLARIS_23();
    ossLinkBer(world);
    _oss_post_init(world);
}

static long _edOrg_M_IPBinaryAddress(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_IPBinaryAddress *_in_data);
static void _d_Org_M_IPBinaryAddress(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_IPBinaryAddress *_out_data);
static int _f_Org_M_IPBinaryAddress(struct ossGlobal *_g, Org_M_IPBinaryAddress *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_IPBinaryAddress(struct ossGlobal *_g, Org_M_IPBinaryAddress *_data_ptr);
#endif
static long _ed0Org_M_IPTextRepresentedAddr(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_IPTextRepresentedAddress *_in_data);
static void _d_0Org_M_IPTextRepresentedAddr(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_IPTextRepresentedAddress *_out_data);
static int _f_0Org_M_IPTextRepresentedAddr(struct ossGlobal *_g, Org_M_IPTextRepresentedAddress *_data_ptr);
#ifdef OSSPRINT
static int _p_0Org_M_IPTextRepresentedAddr(struct ossGlobal *_g, Org_M_IPTextRepresentedAddress *_data_ptr);
#endif
static long _edOrg_M_IPAddress(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_IPAddress *_in_data);
static void _d_Org_M_IPAddress(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_IPAddress *_out_data);
static int _f_Org_M_IPAddress(struct ossGlobal *_g, Org_M_IPAddress *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_IPAddress(struct ossGlobal *_g, Org_M_IPAddress *_data_ptr);
#endif
static long _edOrg_M_PDPAddress(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_PDPAddress *_in_data);
static void _d_Org_M_PDPAddress(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_PDPAddress *_out_data);
static int _f_Org_M_PDPAddress(struct ossGlobal *_g, Org_M_PDPAddress *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_PDPAddress(struct ossGlobal *_g, Org_M_PDPAddress *_data_ptr);
#endif
static long _edOrg_M_QoSInformation(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_QoSInformation *_in_data);
static void _d_Org_M_QoSInformation(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_QoSInformation *_out_data);
static int _f_Org_M_QoSInformation(struct ossGlobal *_g, Org_M_QoSInformation *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_QoSInformation(struct ossGlobal *_g, Org_M_QoSInformation *_data_ptr);
#endif
static long _edOrg_M_ChangeOfCharCondition(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ChangeOfCharCondition *_in_data);
static void _d_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ChangeOfCharCondition *_out_data);
static int _f_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, Org_M_ChangeOfCharCondition *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, Org_M_ChangeOfCharCondition *_data_ptr);
#endif
static long _edOrg_M_ManagementExtension(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ManagementExtension *_in_data);
static void _d_Org_M_ManagementExtension(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ManagementExtension *_out_data);
static int _f_Org_M_ManagementExtension(struct ossGlobal *_g, Org_M_ManagementExtension *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_ManagementExtension(struct ossGlobal *_g, Org_M_ManagementExtension *_data_ptr);
#endif
static long _edOrg_M_Diagnostics(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_Diagnostics *_in_data);
static void _d_Org_M_Diagnostics(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_Diagnostics *_out_data);
static int _f_Org_M_Diagnostics(struct ossGlobal *_g, Org_M_Diagnostics *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_Diagnostics(struct ossGlobal *_g, Org_M_Diagnostics *_data_ptr);
#endif
static long _edOrg_M_ManagementExtensions(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ManagementExtensions *_in_data);
static void _d_Org_M_ManagementExtensions(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ManagementExtensions *_out_data);
static int _f_Org_M_ManagementExtensions(struct ossGlobal *_g, Org_M_ManagementExtensions *_data_ptr);
#ifdef OSSPRINT
static int _p_Org_M_ManagementExtensions(struct ossGlobal *_g, Org_M_ManagementExtensions *_data_ptr);
#endif
static int _eOrg_M_BSRecord(struct ossGlobal *_g, void *_inbuf, char **_outbuf, long *_outlen, unsigned _flags);
static int _dOrg_M_BSRecord(struct ossGlobal *_g, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen);
static int _fOrg_M_BSRecord(struct ossGlobal *_g, void *_data);
#ifdef OSSPRINT
static int _pOrg_M_BSRecord(struct ossGlobal *_g, void *_data);
#endif
...
static const _Context_Id _context_id[] = {
    {"Org_M_iPBinV4Address", "OCTET STRING", _octetstring_type},
    {"Org_M_iPBinV6Address", "OCTET STRING", _octetstring_type},
    {"Org_M_iPTextV4Address", "Character String", _charstring_type},
    {"Org_M_iPTextV6Address", "Character String", _charstring_type},
    {"Org_M_iPBinaryAddress", "IPBinaryAddress", _choice_type},
    {"Org_M_iPTextRepresentedAddress", "IPTextRepresentedAddress", _choice_type},
    {"Org_M_iPAddress", "IPAddress", _choice_type},
    {"Org_M_eTSIAddress", "AddressString", _octetstring_type},
    ...
    {"Org_M_qosNegotiated", "QoSInformation", _sequence_type},
    {"Org_M_qosRequested", "QoSInformation", _sequence_type},
    {"information", "OCTET STRING", _octetstring_type},
    {"Org_M_significance", "BOOLEAN", _boolean_type},
    {"identifier", "OBJECT IDENTIFIER", _object_identifier_type},
    {"Org_M_gsm0408Cause", "INTEGER", _integer_type},
    {"Org_M_gsm0902MapErrorValue", "INTEGER", _integer_type},
    {"Org_M_ccittQ767Cause", "INTEGER", _integer_type},
    {"Org_M_networkSpecificCause", "ManagementExtension", _sequence_type},
    {"Org_M_manufacturerSpecificCause", "ManagementExtension", _sequence_type},
    ...
    {"Org_M_sgsnPDPRecord", "SGSNPDPRecord", _set_type},
    {"Org_M_SGSNPDPRecord_servedMSISDN", "ISDN-AddressString", _octetstring_type},
    {"accessPointNameOI", "AccessPointNameOI", _charstring_type},
    {"Org_M_SGSNPDPRecord_apnSelectionMode", "APNSelectionMode", _enumerated_type},
    {"Org_M_SGSNPDPRecord_localSequenceNumber", "LocalSequenceNumber", _integer_type},
    {"Org_M_SGSNPDPRecord_recordExtensions", "ManagementExtensions", _set_of_type},
    {"Org_M_SGSNPDPRecord_nodeID", "NodeID", _charstring_type},
    {"Org_M_SGSNPDPRecord_recordSequenceNumber", "INTEGER", _integer_type},
    {"Org_M_SGSNPDPRecord_diagnostics", "Diagnostics", _choice_type},
    {"causeForRecClosing", "CauseForRecClosing", _integer_type},
    {"Org_M_SGSNPDPRecord_sgsnChange", "SGSNChange", _boolean_type},
    ...
    {"Org_M_SGSNPDPRecord_cellIdentity", "CellId", _octetstring_type},
    {"Org_M_SGSNPDPRecord_locationAreaCode", "LocationAreaCode", _octetstring_type},
    {"Org_M_SGSNPDPRecord_routingArea", "RoutingAreaCode", _octetstring_type},
    {"Org_M_SGSNPDPRecord_msNetworkCapability", "MSNetworkCapability", _octetstring_type},
    {"sgsnAddress", "IPAddress", _choice_type},
    {"Org_M_SGSNPDPRecord_servedIMEI", "IMEI", _octetstring_type},
    {"servedIMSI", "IMSI", _octetstring_type},
    {"Org_M_SGSNPDPRecord_anonymousAccessIndicator", "BOOLEAN", _boolean_type},
    {"Org_M_SGSNPDPRecord_networkInitiation", "NetworkInitiatedPDPContext", _boolean_type},
    {"recordType", "CallEventRecordType", _integer_type},
    {"Org_M_ggsnPDPRecord", "GGSNPDPRecord", _set_type},
    {"Org_M_GGSNPDPRecord_servedMSISDN", "ISDN-AddressString", _octetstring_type},
    {"Org_M_sgsnPLMNIdentifier", "PLMN-Id", _octetstring_type},
    {"Org_M_GGSNPDPRecord_apnSelectionMode", "APNSelectionMode", _enumerated_type},
    {"Org_M_GGSNPDPRecord_localSequenceNumber", "LocalSequenceNumber", _integer_type},
    {"Org_M_GGSNPDPRecord_recordExtensions", "ManagementExtensions", _set_of_type},
    {"Org_M_GGSNPDPRecord_nodeID", "NodeID", _charstring_type},
    {"Org_M_GGSNPDPRecord_recordSequenceNumber", "INTEGER", _integer_type},
    {"Org_M_GGSNPDPRecord_diagnostics", "Diagnostics", _choice_type},
    {"Org_M_dynamicAddressFlag", "DynamicAddressFlag", _boolean_type},
    {"Org_M_remotePDPAddress", "SEQUENCE OF", _sequence_of_type},
    ...
    {"Org_M_GGSNPDPRecord_anonymousAccessIndicator", "BOOLEAN", _boolean_type},
    {"Org_M_GGSNPDPRecord_networkInitiation", "NetworkInitiatedPDPContext", _boolean_type},
    {"Org_M_sgsnMMRecord", "SGSNMMRecord", _set_type},
    {"Org_M_SGSNMMRecord_localSequenceNumber", "LocalSequenceNumber", _integer_type},
    {"Org_M_SGSNMMRecord_recordExtensions", "ManagementExtensions", _set_of_type},
    {"Org_M_SGSNMMRecord_nodeID", "NodeID", _charstring_type},
    {"Org_M_SGSNMMRecord_recordSequenceNumber", "INTEGER", _integer_type},
    {"Org_M_SGSNMMRecord_diagnostics", "Diagnostics", _choice_type},
    {"Org_M_SGSNMMRecord_sgsnChange", "SGSNChange", _boolean_type},
    {"Org_M_duration", "CallDuration", _integer_type},
    {"Org_M_changeLocation", "SEQUENCE OF", _sequence_of_type},
    {NULL, "ChangeLocation", _sequence_type},
    {"Org_M_cellId", "CellId", _octetstring_type},
    {"routingAreaCode", "RoutingAreaCode", _octetstring_type},
    {"locationAreaCode", "LocationAreaCode", _octetstring_type},
    {"Org_M_SGSNMMRecord_cellIdentity", "CellId", _octetstring_type},
    {"Org_M_SGSNMMRecord_locationAreaCode", "LocationAreaCode", _octetstring_type},
    {"Org_M_SGSNMMRecord_routingArea", "RoutingAreaCode", _octetstring_type},
    {"Org_M_SGSNMMRecord_msNetworkCapability", "MSNetworkCapability", _octetstring_type},
    {"Org_M_SGSNMMRecord_servedIMEI", "IMEI", _octetstring_type},
    {"Org_M_sgsnSMORecord", "SGSNSMORecord", _set_type},
    {"Org_M_SGSNSMORecord_localSequenceNumber", "LocalSequenceNumber", _integer_type},
    {"Org_M_SGSNSMORecord_nodeID", "NodeID", _charstring_type},
    {"Org_M_SGSNSMORecord_recordExtensions", "ManagementExtensions", _set_of_type},
    {"Org_M_SGSNSMORecord_smsResult", "Diagnostics", _choice_type},
    {"originationTime", "TimeStamp", _octetstring_type},
    {"messageReference", "MessageReference", _octetstring_type},
    {"Org_M_SGSNSMORecord_cellIdentity", "CellId", _octetstring_type},
    {"Org_M_SGSNSMORecord_routingArea", "RoutingAreaCode", _octetstring_type},
    {"Org_M_SGSNSMORecord_locationArea", "LocationAreaCode", _octetstring_type},
    ...
    {"Org_M_SGSNSMORecord_servedMSISDN", "ISDN-AddressString", _octetstring_type},
    {"Org_M_SGSNSMORecord_servedIMEI", "IMEI", _octetstring_type},
    {"Org_M_sgsnSMTRecord", "SGSNSMTRecord", _set_type},
    {"Org_M_SGSNSMTRecord_localSequenceNumber", "LocalSequenceNumber", _integer_type},
    {"Org_M_SGSNSMTRecord_nodeID", "NodeID", _charstring_type},
    {"Org_M_SGSNSMTRecord_recordExtensions", "ManagementExtensions", _set_of_type},
    {"Org_M_SGSNSMTRecord_smsResult", "Diagnostics", _choice_type},
    {"Org_M_SGSNSMTRecord_cellIdentity", "CellId", _octetstring_type},
    {"Org_M_SGSNSMTRecord_routingArea", "RoutingAreaCode", _octetstring_type},
    {"Org_M_SGSNSMTRecord_locationArea", "LocationAreaCode", _octetstring_type},
    {"Org_M_SGSNSMTRecord_servedMSISDN", "ISDN-AddressString", _octetstring_type},
    {"Org_M_SGSNSMTRecord_servedIMEI", "IMEI", _octetstring_type},
...
static long _edOrg_M_IPAddress(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_IPAddress *_in_data)
{
	...
	case 1:
	    ...
	    _data_len = _edOrg_M_IPBinaryAddress(_g, _out_pos, &_out_len, &_in_data->u.iPBinaryAddress);
	    _constructed = TRUE;
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	case 2:
	    ...
	    _data_len = _ed0Org_M_IPTextRepresentedAddr(_g, _out_pos, &_out_len, &_in_data->u.iPTextRepresentedAddress);
	    _constructed = TRUE;
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static long _edOrg_M_PDPAddress(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_PDPAddress *_in_data)
{
	...
	case 1:
	    ...
	    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_in_data->u.iPAddress);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
	    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8000, _constructed);
#if OSSDEBUG > 1
...
static long _edOrg_M_ChangeOfCharCondition(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ChangeOfCharCondition *_in_data)
{
	...
	if (_in_data->bit_mask & Org_M_qosNegotiated_present) {
	    _data_len = _edOrg_M_QoSInformation(_g, _out_pos, &_out_len, &_in_data->qosNegotiated);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
	    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8002, _constructed);
	    _total_len += _data_len;
	...
	if (_in_data->bit_mask & Org_M_qosRequested_present) {
	    _data_len = _edOrg_M_QoSInformation(_g, _out_pos, &_out_len, &_in_data->qosRequested);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
	    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8001, _constructed);
	    _total_len += _data_len;
...
static long _edOrg_M_ManagementExtension(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ManagementExtension *_in_data)
{
	...
	if (_in_data->bit_mask & Org_M_significance_present) {
...
static long _edOrg_M_Diagnostics(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_Diagnostics *_in_data)
{
	...
	case 4:
	    ...
	    _data_len = _edOrg_M_ManagementExtension(_g, _out_pos, &_out_len, &_in_data->u.networkSpecificCause);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
	    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8003, _constructed);
#if OSSDEBUG > 1
	...
	case 5:
	    ...
	    _data_len = _edOrg_M_ManagementExtension(_g, _out_pos, &_out_len, &_in_data->u.manufacturerSpecificCause);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
	    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8004, _constructed);
#if OSSDEBUG > 1
...
static long _edOrg_M_ManagementExtensions(struct ossGlobal *_g, char **_out_pos, long *_max_len, Org_M_ManagementExtensions *_in_data)
{
	...
	_oss_enc_error(_g, TRUE, _bad_pointer, 0L);
    {
	struct Org_M_ManagementExtensions_	*_temp;
	unsigned long count;
	...
	for (_lindex = 0; _lindex < count; _lindex++) {
	    ...
	    _temp = (struct Org_M_ManagementExtensions_ *) _oss_enc_pop(_g);
	    _data_len = _edOrg_M_ManagementExtension(_g, _out_pos, &_out_len, &_temp->value);
	    _constructed = TRUE;
	    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
...
static int _eOrg_M_BSRecord(struct ossGlobal *_g, void *_inbuf, char **_outbuf, long *_outlen, unsigned _flags)
{
    ...
    _in_data = (Org_M_BSRecord *) _inbuf;
...

	{
		...
		_temp = (struct Org_M__seqof5 *) _oss_enc_pop(_g);
		{
#if OSSDEBUG > 1
		    _Context_Element _element;
...

			{
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedMSISDN_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_apnSelectionMode_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_localSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordExtensions_present) {
				_data_len = _edOrg_M_ManagementExtensions(_g, _out_pos, &_out_len, &_temp->value.u.sgsnPDPRecord.recordExtensions);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_nodeID_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_diagnostics_present) {
				_data_len = _edOrg_M_Diagnostics(_g, _out_pos, &_out_len, &_temp->value.u.sgsnPDPRecord.diagnostics);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_sgsnChange_present) {
				...
				for (_lindex = 0; _lindex < count; _lindex++) {
				    ...
				    _temp1 = (struct Org_M__seqof1_ *) _oss_enc_pop(_g);
				    _data_len = _edOrg_M_ChangeOfCharCondition(_g, _out_pos, &_out_len, &_temp1->value);
				    _constructed = TRUE;
				    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x10, _constructed);
				    _total_len += _data_len;
			    ...
			    _data_len = _edOrg_M_PDPAddress(_g, _out_pos, &_out_len, &_temp->value.u.sgsnPDPRecord.servedPDPAddress);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    ...
			    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_temp->value.u.sgsnPDPRecord.ggsnAddressUsed);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_cellIdentity_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_locationAreaCode_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_routingArea_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_msNetworkCapability_present) {
			    ...
			    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_temp->value.u.sgsnPDPRecord.sgsnAddress);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8005, _constructed);
			    _total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedIMEI_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_anonymousAccessIndicator_present) {
			    ...
			    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_networkInitiation_present) {
...

			{
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_servedMSISDN_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_sgsnPLMNIdentifier_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_apnSelectionMode_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_localSequenceNumber_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordExtensions_present) {
				_data_len = _edOrg_M_ManagementExtensions(_g, _out_pos, &_out_len, &_temp->value.u.ggsnPDPRecord.recordExtensions);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8013, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_nodeID_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordSequenceNumber_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_diagnostics_present) {
				_data_len = _edOrg_M_Diagnostics(_g, _out_pos, &_out_len, &_temp->value.u.ggsnPDPRecord.diagnostics);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8010, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_dynamicAddressFlag_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_remotePDPAddress_present) {
				{
				    struct Org_M__seqof3	*_temp1;
				    unsigned long count;
				    unsigned long _lindex;
				    long _total_len = 0;
					...
					_temp1 = (struct Org_M__seqof3 *) _oss_enc_pop(_g);
					_data_len = _edOrg_M_PDPAddress(_g, _out_pos, &_out_len, &_temp1->value);
					_constructed = TRUE;
					_total_len += _data_len;
				    }
#if OSSDEBUG > 1
			    ...
			    _data_len = _edOrg_M_PDPAddress(_g, _out_pos, &_out_len, &_temp->value.u.ggsnPDPRecord.servedPDPAddress);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8009, _constructed);
			    _total_len += _data_len;
				...
				for (_lindex = 0; _lindex < count; _lindex++) {
				    ...
				    _temp1 = (struct Org_M__seqof2 *) _oss_enc_pop(_g);
				    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_temp1->value);
				    _constructed = TRUE;
				    _total_len += _data_len;
				}
#if OSSDEBUG > 1
			    ...
			    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_temp->value.u.ggsnPDPRecord.ggsnAddress);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8004, _constructed);
			    _total_len += _data_len;
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_anonymousAccessIndicator_present) {
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_networkInitiation_present) {
...

			{
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_localSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordExtensions_present) {
				_data_len = _edOrg_M_ManagementExtensions(_g, _out_pos, &_out_len, &_temp->value.u.sgsnMMRecord.recordExtensions);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8010, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_nodeID_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_diagnostics_present) {
				_data_len = _edOrg_M_Diagnostics(_g, _out_pos, &_out_len, &_temp->value.u.sgsnMMRecord.diagnostics);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x800D, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_sgsnChange_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_duration_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_changeLocation_present) {
				{
				    struct Org_M__seqof4	*_temp1;
				    unsigned long count;
				    unsigned long _lindex;
				    long _total_len = 0;
					...
					_temp1 = (struct Org_M__seqof4 *) _oss_enc_pop(_g);
					{
					    long _total_len = 0;
					    ...
					    if (_temp1->value.bit_mask & Org_M_cellId_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_cellIdentity_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_locationAreaCode_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_routingArea_present) {
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_msNetworkCapability_present) {
			    ...
			    _data_len = _edOrg_M_IPAddress(_g, _out_pos, &_out_len, &_temp->value.u.sgsnMMRecord.sgsnAddress);
			    _constructed = TRUE;
			    _data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
			    _data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x8003, _constructed);
			    _total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_servedIMEI_present) {
...

			{
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_localSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_nodeID_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_recordExtensions_present) {
				_data_len = _edOrg_M_ManagementExtensions(_g, _out_pos, &_out_len, &_temp->value.u.sgsnSMORecord.recordExtensions);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x800D, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_smsResult_present) {
				_data_len = _edOrg_M_Diagnostics(_g, _out_pos, &_out_len, &_temp->value.u.sgsnSMORecord.smsResult);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x800C, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_cellIdentity_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_routingArea_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_locationArea_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedMSISDN_present) {
			    ...
			    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedIMEI_present) {
...

			{
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_localSequenceNumber_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_nodeID_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_recordExtensions_present) {
				_data_len = _edOrg_M_ManagementExtensions(_g, _out_pos, &_out_len, &_temp->value.u.sgsnSMTRecord.recordExtensions);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x800C, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_smsResult_present) {
				_data_len = _edOrg_M_Diagnostics(_g, _out_pos, &_out_len, &_temp->value.u.sgsnSMTRecord.smsResult);
				_constructed = TRUE;
				_data_len += _oss_encd_length(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, _data_len);
				_data_len += _oss_encd_tag(_g, _out_pos, &_out_len, _oss_c->_buffer_provided, (unsigned short) 0x800B, _constructed);
				_total_len += _data_len;
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_cellIdentity_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_routingArea_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_locationArea_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedMSISDN_present) {
			    ...
			    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedIMEI_present) {
...
static int _emCDRF_R98(struct ossGlobal *_g, int _pdunum, void *_inbuf, char **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    ...
    {
	case 1:
	    _rc = _eOrg_M_BSRecord(_g, _inbuf, _outbuf, _outlen, _flags);
	    break;
...
static void _d_Org_M_IPAddress(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_IPAddress *_out_data)
{
	...
	if (_data_tag == 0x8000 || _data_tag == 0x8001) {
	    ...
	    _out_data->choice = 1;
	    _d_Org_M_IPBinaryAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->u.iPBinaryAddress);
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	if (_data_tag == 0x8002 || _data_tag == 0x8003) {
	    ...
	    _out_data->choice = 2;
	    _d_0Org_M_IPTextRepresentedAddr(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->u.iPTextRepresentedAddress);
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static void _d_Org_M_PDPAddress(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_PDPAddress *_out_data)
{
	...
	default:
		...
		_d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->u.iPAddress);
		while (_indef_tags > 0) {
		    _oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
...
static void _d_Org_M_QoSInformation(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_QoSInformation *_out_data)
{
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->reliability = (enum Org_M_QoSReliability) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->delay = (enum Org_M_QoSDelay) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->precedence = (enum Org_M_QoSPrecedence) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->peakThroughput = (enum Org_M_QoSPeakThroughput) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->meanThroughput = (enum Org_M_QoSMeanThroughput) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static void _d_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ChangeOfCharCondition *_out_data)
{
	...
	if (_data_tag != 0x8001 || (_total_len >= 0 && *_in_pos >= _end_pos))
	    _out_data->bit_mask &= ~Org_M_qosRequested_present;
	else {
	    _out_data->bit_mask |= Org_M_qosRequested_present;
#if OSSDEBUG > 1
	    _element._id = (_Context_Id *)&_context_id[18];
	    ...
	    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	    _d_Org_M_QoSInformation(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->qosRequested);
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	if (_data_tag != 0x8002 || (_total_len >= 0 && *_in_pos >= _end_pos))
	    _out_data->bit_mask &= ~Org_M_qosNegotiated_present;
	else {
	    _out_data->bit_mask |= Org_M_qosNegotiated_present;
#if OSSDEBUG > 1
	    _element._id = (_Context_Id *)&_context_id[17];
	    ...
	    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	    _d_Org_M_QoSInformation(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->qosNegotiated);
#if OSSDEBUG > 1
	    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	_out_data->changeCondition = (enum Org_M_ChangeCondition) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static void _d_Org_M_ManagementExtension(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ManagementExtension *_out_data)
{
	...
	if (_data_tag != 0x8001 || (_total_len >= 0 && *_in_pos >= _end_pos)) {
	    _out_data->bit_mask &= ~Org_M_significance_present;
...
static void _d_Org_M_Diagnostics(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_Diagnostics *_out_data)
{
	...
	default:
		...
		_oss_c->_tag_decoded = FALSE;
		_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
		_d_Org_M_ManagementExtension(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->u.networkSpecificCause);
#if OSSDEBUG > 1
		_oss_c->_oss_context_anchor._last = _element._parent;
#endif
		...
		_oss_c->_tag_decoded = FALSE;
		_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
		_d_Org_M_ManagementExtension(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_out_data->u.manufacturerSpecificCause);
#if OSSDEBUG > 1
		_oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static void _d_Org_M_ManagementExtensions(struct ossGlobal *_g, char **_in_pos, long *_buf_len, long _data_length, unsigned short _data_tag, ossBoolean _tag_constructed, Org_M_ManagementExtensions *_out_data)
{
	...
	while (TRUE) {
	    ...
	    if (_temp) {
		_temp->next = (struct Org_M_ManagementExtensions_ *) _oss_dec_getmem(_g, sizeof(struct Org_M_ManagementExtensions_)*1, _oss_c->_buffer_provided);
		_temp = _temp->next;
	    } else {
		_temp = (struct Org_M_ManagementExtensions_ *) _oss_dec_getmem(_g, sizeof(struct Org_M_ManagementExtensions_)*1, _oss_c->_buffer_provided);
		*_out_data = _temp;
	    }
	    _temp->next = NULL;
#if OSSDEBUG > 1
	    ...
	    _oss_c->_tag_decoded = FALSE;
	    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	    _d_Org_M_ManagementExtension(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value);
	}
#if OSSDEBUG > 1
	_oss_c->_oss_context_anchor._last = _element._parent;
#endif
...
static int _dOrg_M_BSRecord(struct ossGlobal *_g, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen)
{
    ...
    _oss_c->_oss_context_anchor._pdu_number = 0;
#endif
    _out_data = (struct Org_M_BSRecord *) _oss_dec_getmem(_g, sizeof(struct Org_M_BSRecord)*1, _oss_c->_buffer_provided);
    _oss_c->_tag_decoded = FALSE;
	...
	_data_length = _oss_dec_length(_g, _in_pos, _buf_len);
	{
		...
		count++;
		if (_temp) {
		    _temp->next = (struct Org_M__seqof5 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof5)*1, _oss_c->_buffer_provided);
		    _temp = _temp->next;
		} else {
		    _temp = (struct Org_M__seqof5 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof5)*1, _oss_c->_buffer_provided);
			...
			case 0x0: {
				...
				while (TRUE) {
					...
					case 0x1: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_networkInitiation_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_networkInitiation_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x2: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_anonymousAccessIndicator_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_anonymousAccessIndicator_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x4: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedIMEI_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_servedIMEI_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x5: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnPDPRecord.sgsnAddress);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0x6: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_msNetworkCapability_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_msNetworkCapability_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x7: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_routingArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_routingArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x8: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_locationAreaCode_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_locationAreaCode_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x9: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_cellIdentity_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_cellIdentity_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xB: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnPDPRecord.ggsnAddressUsed);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xE: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_PDPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnPDPRecord.servedPDPAddress);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xF: {
						...
						while (TRUE) {
						    ...
						    if (_data_tag != 0x10) _oss_dec_error(_g, TRUE, _tag_mismatch, (long)_data_tag);
						    if (_temp1) {
							_temp1->next = (struct Org_M__seqof1_ *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof1_)*1, _oss_c->_buffer_provided);
							_temp1 = _temp1->next;
						    } else {
							_temp1 = (struct Org_M__seqof1_ *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof1_)*1, _oss_c->_buffer_provided);
						    ...
						    _oss_c->_tag_decoded = FALSE;
						    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
						    _d_Org_M_ChangeOfCharCondition(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp1->value);
						}
#if OSSDEBUG > 1
						_oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0x12: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_sgsnChange_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_sgsnChange_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x14: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_diagnostics_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_diagnostics_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_Diagnostics(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnPDPRecord.diagnostics);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0x15: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_recordSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x16: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_nodeID_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_nodeID_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x17: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordExtensions_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_recordExtensions_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _d_Org_M_ManagementExtensions(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnPDPRecord.recordExtensions);
					...
					case 0x18: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_localSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_localSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x19: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_apnSelectionMode_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_apnSelectionMode_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _temp->value.u.sgsnPDPRecord.apnSelectionMode = (enum Org_M_APNSelectionMode) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
					...
					case 0x1D: {
					    ...
					    if (_temp->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedMSISDN_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnPDPRecord.bit_mask |= Org_M_SGSNPDPRecord_servedMSISDN_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
			...
			case 0x1: {
				...
				while (TRUE) {
					...
					case 0x1: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_networkInitiation_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_networkInitiation_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x2: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_anonymousAccessIndicator_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_anonymousAccessIndicator_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x4: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.ggsnPDPRecord.ggsnAddress);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0x6: {
						...
						while (TRUE) {
						    ...
						    count++;
						    if (_temp1) {
							_temp1->next = (struct Org_M__seqof2 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof2)*1, _oss_c->_buffer_provided);
							_temp1 = _temp1->next;
						    } else {
							_temp1 = (struct Org_M__seqof2 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof2)*1, _oss_c->_buffer_provided);
						    ...
						    _d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp1->value);
						}
#if OSSDEBUG > 1
						_oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0x9: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_PDPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.ggsnPDPRecord.servedPDPAddress);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xA: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_remotePDPAddress_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_remotePDPAddress_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    {
						struct Org_M__seqof3	*_temp1;
						...
						while (TRUE) {
						    ...
						    count++;
						    if (_temp1) {
							_temp1->next = (struct Org_M__seqof3 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof3)*1, _oss_c->_buffer_provided);
							_temp1 = _temp1->next;
						    } else {
							_temp1 = (struct Org_M__seqof3 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof3)*1, _oss_c->_buffer_provided);
						    ...
						    _d_Org_M_PDPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp1->value);
						}
#if OSSDEBUG > 1
						_oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0xB: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_dynamicAddressFlag_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_dynamicAddressFlag_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x10: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_diagnostics_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_diagnostics_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_Diagnostics(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.ggsnPDPRecord.diagnostics);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0x11: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_recordSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x12: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_nodeID_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_nodeID_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x13: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordExtensions_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_recordExtensions_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _d_Org_M_ManagementExtensions(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.ggsnPDPRecord.recordExtensions);
					    _present_flags |= 0x80000;
#if OSSDEBUG > 1
					    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0x14: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_localSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_localSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x15: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_apnSelectionMode_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_apnSelectionMode_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _temp->value.u.ggsnPDPRecord.apnSelectionMode = (enum Org_M_APNSelectionMode) _oss_dec_uiint(_g, _in_pos, _buf_len, _data_length);
					    _present_flags |= 0x200000;
#if OSSDEBUG > 1
					    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0x1B: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_sgsnPLMNIdentifier_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_sgsnPLMNIdentifier_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
...
/*ldf，2004-08-13 合入CGW 1.8.0.0.60,对应问题单SWPD07573,同B01对应问题单D20663,仅针对Motorola版本*/                                                            
					...
					case 0x1D: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_servedMSISDN_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Org_M_GGSNPDPRecord_servedMSISDN_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
			...
			case 0x2: {
				...
				while (TRUE) {
					...
					case 0x2: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_servedIMEI_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_servedIMEI_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x3: {
					    ...
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_IPAddress(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnMMRecord.sgsnAddress);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0x4: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_msNetworkCapability_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_msNetworkCapability_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x5: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_routingArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_routingArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x6: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_locationAreaCode_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_locationAreaCode_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x7: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_cellIdentity_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_cellIdentity_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x8: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_changeLocation_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_changeLocation_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    {
						struct Org_M__seqof4	*_temp1;
						...
						while (TRUE) {
						    ...
						    if (_data_tag != 0x10) _oss_dec_error(_g, TRUE, _tag_mismatch, (long)_data_tag);
						    if (_temp1) {
							_temp1->next = (struct Org_M__seqof4 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof4)*1, _oss_c->_buffer_provided);
							_temp1 = _temp1->next;
						    } else {
							_temp1 = (struct Org_M__seqof4 *) _oss_dec_getmem(_g, sizeof(struct Org_M__seqof4)*1, _oss_c->_buffer_provided);
							...
							if (_data_tag != 0x8002 || (_total_len >= 0 && *_in_pos >= _end_pos))
							    _temp1->value.bit_mask &= ~Org_M_cellId_present;
							else {
							    _temp1->value.bit_mask |= Org_M_cellId_present;
#if OSSDEBUG > 1
							    _element._id = (_Context_Id *)&_context_id[88];
					...
					case 0xA: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_duration_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_duration_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xB: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_sgsnChange_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_sgsnChange_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xD: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_diagnostics_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_diagnostics_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_Diagnostics(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnMMRecord.diagnostics);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xE: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_recordSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xF: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_nodeID_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_nodeID_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x10: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordExtensions_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_recordExtensions_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _d_Org_M_ManagementExtensions(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnMMRecord.recordExtensions);
					    _present_flags |= 0x10000;
#if OSSDEBUG > 1
					    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0x11: {
					    ...
					    if (_temp->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_localSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnMMRecord.bit_mask |= Org_M_SGSNMMRecord_localSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
			...
			case 0x3: {
				...
				while (TRUE) {
					...
					case 0x2: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedIMEI_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_servedIMEI_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x3: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedMSISDN_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_servedMSISDN_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x7: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_locationArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_locationArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x8: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_routingArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_routingArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x9: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_cellIdentity_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_cellIdentity_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xC: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_smsResult_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_smsResult_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_Diagnostics(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnSMORecord.smsResult);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xD: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_recordExtensions_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_recordExtensions_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _d_Org_M_ManagementExtensions(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnSMORecord.recordExtensions);
					    _present_flags |= 0x2000;
#if OSSDEBUG > 1
					    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0xE: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_nodeID_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_nodeID_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xF: {
					    ...
					    if (_temp->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_localSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMORecord.bit_mask |= Org_M_SGSNSMORecord_localSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
			...
			case 0x4: {
				...
				while (TRUE) {
					...
					case 0x2: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedIMEI_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_servedIMEI_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x3: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedMSISDN_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_servedMSISDN_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x7: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_locationArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_locationArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x8: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_routingArea_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_routingArea_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0x9: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_cellIdentity_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_cellIdentity_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xB: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_smsResult_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_smsResult_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    if (_data_length < 0) ++_indef_tags;
					    _d_Org_M_Diagnostics(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnSMTRecord.smsResult);
					    while (_indef_tags > 0) {
						_oss_dec_tag(_g, _in_pos, _buf_len, &_data_tag, &_constructed);
						if (_data_tag != 0) _oss_dec_error(_g, TRUE, _expec_eoc, 0L);
						if (_oss_dec_length(_g, _in_pos, _buf_len) != 0) _oss_dec_error(_g, TRUE, _non_std_eoc, 0L);
					...
					case 0xC: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_recordExtensions_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_recordExtensions_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					    _d_Org_M_ManagementExtensions(_g, _in_pos, _buf_len, _data_length, _data_tag, _constructed, &_temp->value.u.sgsnSMTRecord.recordExtensions);
					    _present_flags |= 0x1000;
#if OSSDEBUG > 1
					    _oss_c->_oss_context_anchor._last = _element._parent;
#endif
					...
					case 0xD: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_nodeID_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_nodeID_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
					...
					case 0xE: {
					    ...
					    if (_temp->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_localSequenceNumber_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.sgsnSMTRecord.bit_mask |= Org_M_SGSNSMTRecord_localSequenceNumber_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
...
static int _dmCDRF_R98(struct ossGlobal *_g, int *_pdunum, char **_inbuf, long *_inlen, void **_outbuf, long *_outlen, void *_ctl_tbl, unsigned _flags, char _errmsg[ERR_MSG_LENGTH])
{
    ...
    _oss_c->_restrain_size = (_oss_c->_restrain_mode) ? *_outlen : 0;
    *_pdunum = 1;
    _rc = _dOrg_M_BSRecord(_g, _inbuf, _inlen, _outbuf, _outlen);
    _oss_c->_oss_err_msg = NULL;
    return _rc;
}
...
static int _f_Org_M_IPAddress(struct ossGlobal *_g, Org_M_IPAddress *_data_ptr)
{
    switch (_data_ptr->choice) {
    case 1:
	_f_Org_M_IPBinaryAddress(_g, &_data_ptr->u.iPBinaryAddress);
	break;

    case 2:
	_f_0Org_M_IPTextRepresentedAddr(_g, &_data_ptr->u.iPTextRepresentedAddress);
	break;
...
static int _f_Org_M_PDPAddress(struct ossGlobal *_g, Org_M_PDPAddress *_data_ptr)
{
    switch (_data_ptr->choice) {
    case 1:
	_f_Org_M_IPAddress(_g, &_data_ptr->u.iPAddress);
	break;
...
static int _f_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, Org_M_ChangeOfCharCondition *_data_ptr)
{
    if (_data_ptr->bit_mask & Org_M_qosRequested_present) {
	_f_Org_M_QoSInformation(_g, &_data_ptr->qosRequested);
    }

    if (_data_ptr->bit_mask & Org_M_qosNegotiated_present) {
	_f_Org_M_QoSInformation(_g, &_data_ptr->qosNegotiated);
    }
...
static int _f_Org_M_ManagementExtension(struct ossGlobal *_g, Org_M_ManagementExtension *_data_ptr)
{
    ...
    if (_data_ptr->bit_mask & Org_M_significance_present) {
    }
...
static int _f_Org_M_Diagnostics(struct ossGlobal *_g, Org_M_Diagnostics *_data_ptr)
{
    ...
    case 4:
	_f_Org_M_ManagementExtension(_g, &_data_ptr->u.networkSpecificCause);
	break;

    case 5:
	_f_Org_M_ManagementExtension(_g, &_data_ptr->u.manufacturerSpecificCause);
	break;
...
{
    if (*_data_ptr) {
	struct Org_M_ManagementExtensions_	*_tempa = *_data_ptr;
	struct Org_M_ManagementExtensions_	*_tempb;
	while (_tempa) {
	    _tempb = _tempa->next;
	    _f_Org_M_ManagementExtension(_g, &_tempa->value);
	    (*_g->freep)(_tempa);
	    _tempa = _tempb;
	}
    }
...
static int _fOrg_M_BSRecord(struct ossGlobal *_g, void *_data)
{
    Org_M_BSRecord	*_data_ptr;
    _data_ptr = (Org_M_BSRecord *) _data;
    if (_data_ptr->listOfCDR) {
	struct Org_M__seqof5	*_tempa = _data_ptr->listOfCDR;
	struct Org_M__seqof5	*_tempb;
	while (_tempa) {
	    _tempb = _tempa->next;
	    switch (_tempa->value.choice) {
	    case 1:
		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_networkInitiation_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_anonymousAccessIndicator_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedIMEI_present) {
		}

		_f_Org_M_IPAddress(_g, &_tempa->value.u.sgsnPDPRecord.sgsnAddress);
		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_msNetworkCapability_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_routingArea_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_locationAreaCode_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_cellIdentity_present) {
		}

		_f_Org_M_IPAddress(_g, &_tempa->value.u.sgsnPDPRecord.ggsnAddressUsed);
		_f_Org_M_PDPAddress(_g, &_tempa->value.u.sgsnPDPRecord.servedPDPAddress);
		if (_tempa->value.u.sgsnPDPRecord.listOfTrafficVolumes) {
		    struct Org_M__seqof1_	*_temp1a = _tempa->value.u.sgsnPDPRecord.listOfTrafficVolumes;
		    struct Org_M__seqof1_	*_temp1b;
		    while (_temp1a) {
			_temp1b = _temp1a->next;
			_f_Org_M_ChangeOfCharCondition(_g, &_temp1a->value);
			(*_g->freep)(_temp1a);
			_temp1a = _temp1b;
		    }
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_sgsnChange_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_diagnostics_present) {
		    _f_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnPDPRecord.diagnostics);
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordSequenceNumber_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_nodeID_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordExtensions_present) {
		    _f_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnPDPRecord.recordExtensions);
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_localSequenceNumber_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_apnSelectionMode_present) {
		}

		if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_servedMSISDN_present) {
		}

		break;

	    case 2:
		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_networkInitiation_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_anonymousAccessIndicator_present) {
		}

		_f_Org_M_IPAddress(_g, &_tempa->value.u.ggsnPDPRecord.ggsnAddress);
		if (_tempa->value.u.ggsnPDPRecord.sgsnAddress) {
		    struct Org_M__seqof2	*_temp1a = _tempa->value.u.ggsnPDPRecord.sgsnAddress;
		    struct Org_M__seqof2	*_temp1b;
		    while (_temp1a) {
			_temp1b = _temp1a->next;
			_f_Org_M_IPAddress(_g, &_temp1a->value);
			(*_g->freep)(_temp1a);
			_temp1a = _temp1b;
		    }
		}

		_f_Org_M_PDPAddress(_g, &_tempa->value.u.ggsnPDPRecord.servedPDPAddress);
		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_remotePDPAddress_present) {
		    if (_tempa->value.u.ggsnPDPRecord.remotePDPAddress) {
			struct Org_M__seqof3	*_temp1a = _tempa->value.u.ggsnPDPRecord.remotePDPAddress;
			struct Org_M__seqof3	*_temp1b;
			while (_temp1a) {
			    _temp1b = _temp1a->next;
			    _f_Org_M_PDPAddress(_g, &_temp1a->value);
			    (*_g->freep)(_temp1a);
			    _temp1a = _temp1b;
			}
		    }
		...
		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_dynamicAddressFlag_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.listOfTrafficVolumes) {
		    struct Org_M__seqof1_	*_temp1a = _tempa->value.u.ggsnPDPRecord.listOfTrafficVolumes;
		    struct Org_M__seqof1_	*_temp1b;
		    while (_temp1a) {
			_temp1b = _temp1a->next;
			_f_Org_M_ChangeOfCharCondition(_g, &_temp1a->value);
		...
		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_diagnostics_present) {
		    _f_Org_M_Diagnostics(_g, &_tempa->value.u.ggsnPDPRecord.diagnostics);
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordSequenceNumber_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_nodeID_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordExtensions_present) {
		    _f_Org_M_ManagementExtensions(_g, &_tempa->value.u.ggsnPDPRecord.recordExtensions);
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_localSequenceNumber_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_apnSelectionMode_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_sgsnPLMNIdentifier_present) {
		}

		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_servedMSISDN_present) {
		}

		break;

	    case 3:
		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_servedIMEI_present) {
		}

		_f_Org_M_IPAddress(_g, &_tempa->value.u.sgsnMMRecord.sgsnAddress);
		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_msNetworkCapability_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_routingArea_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_locationAreaCode_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_cellIdentity_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_changeLocation_present) {
		    if (_tempa->value.u.sgsnMMRecord.changeLocation) {
			struct Org_M__seqof4	*_temp1a = _tempa->value.u.sgsnMMRecord.changeLocation;
			struct Org_M__seqof4	*_temp1b;
			while (_temp1a) {
			    _temp1b = _temp1a->next;
			    if (_temp1a->value.bit_mask & Org_M_cellId_present) {
			    }
		...
		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_duration_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_sgsnChange_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_diagnostics_present) {
		    _f_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnMMRecord.diagnostics);
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordSequenceNumber_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_nodeID_present) {
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordExtensions_present) {
		    _f_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnMMRecord.recordExtensions);
		}

		if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_localSequenceNumber_present) {
		}

		break;

	    case 4:
		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedIMEI_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_servedMSISDN_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_locationArea_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_routingArea_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_cellIdentity_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_smsResult_present) {
		    _f_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnSMORecord.smsResult);
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_recordExtensions_present) {
		    _f_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnSMORecord.recordExtensions);
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_nodeID_present) {
		}

		if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_localSequenceNumber_present) {
		}

		break;

	    case 5:
		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedIMEI_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_servedMSISDN_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_locationArea_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_routingArea_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_cellIdentity_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_smsResult_present) {
		    _f_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnSMTRecord.smsResult);
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_recordExtensions_present) {
		    _f_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnSMTRecord.recordExtensions);
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_nodeID_present) {
		}

		if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_localSequenceNumber_present) {
		}
...
static int _p_Org_M_IPAddress(struct ossGlobal *_g, Org_M_IPAddress *_data_ptr)
{
	...
	_p_Org_M_IPBinaryAddress(_g, &_data_ptr->u.iPBinaryAddress);
	break;

    case 2:
	ossPrint(_g, "iPTextRepresentedAddress : ");
	_p_0Org_M_IPTextRepresentedAddr(_g, &_data_ptr->u.iPTextRepresentedAddress);
	break;
...
static int _p_Org_M_PDPAddress(struct ossGlobal *_g, Org_M_PDPAddress *_data_ptr)
{
	...
	_p_Org_M_IPAddress(_g, &_data_ptr->u.iPAddress);
	break;
...
static int _p_Org_M_ChangeOfCharCondition(struct ossGlobal *_g, Org_M_ChangeOfCharCondition *_data_ptr)
{
	...
	if (_data_ptr->bit_mask & Org_M_qosRequested_present) {
	    ...
	    _p_Org_M_QoSInformation(_g, &_data_ptr->qosRequested);
	    _comma = 1;
	}
	...
	if (_data_ptr->bit_mask & Org_M_qosNegotiated_present) {
	    ...
	    _p_Org_M_QoSInformation(_g, &_data_ptr->qosNegotiated);
	    _comma = 1;
	}
...
static int _p_Org_M_Diagnostics(struct ossGlobal *_g, Org_M_Diagnostics *_data_ptr)
{
	...
	_p_Org_M_ManagementExtension(_g, &_data_ptr->u.networkSpecificCause);
	break;

    case 5:
	ossPrint(_g, "manufacturerSpecificCause : ");
	_p_Org_M_ManagementExtension(_g, &_data_ptr->u.manufacturerSpecificCause);
	break;
...
static int _p_Org_M_ManagementExtensions(struct ossGlobal *_g, Org_M_ManagementExtensions *_data_ptr)
{
	...
	while (_tempa) {
	    _tempb = _tempa->next;
	    _oss_indent(_g, 0);
	    _p_Org_M_ManagementExtension(_g, &_tempa->value);
	    _tempa = _tempb;
	    if (_tempa)
		ossPrint(_g, ",");
	}
...
static int _pOrg_M_BSRecord(struct ossGlobal *_g, void *_data)
{
	...
	if (_data_ptr->listOfCDR) {
		...
		case 1:
			...
			_p_Org_M_IPAddress(_g, &_tempa->value.u.sgsnPDPRecord.sgsnAddress);
			if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_msNetworkCapability_present) {
			    ossPrint(_g, ",");
			    _oss_indent(_g, 0);
			...
			_p_Org_M_IPAddress(_g, &_tempa->value.u.sgsnPDPRecord.ggsnAddressUsed);
			ossPrint(_g, ",");
			_oss_indent(_g, 0);
			...
			_p_Org_M_PDPAddress(_g, &_tempa->value.u.sgsnPDPRecord.servedPDPAddress);
			ossPrint(_g, ",");
			_oss_indent(_g, 0);
			...
			if (_tempa->value.u.sgsnPDPRecord.listOfTrafficVolumes) {
				...
				_temp1b = _temp1a->next;
				_oss_indent(_g, 0);
				_p_Org_M_ChangeOfCharCondition(_g, &_temp1a->value);
				_temp1a = _temp1b;
				if (_temp1a)
				    ossPrint(_g, ",");
			    }
			...
			if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_diagnostics_present) {
			    ...
			    _p_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnPDPRecord.diagnostics);
			}
			...
			if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordSequenceNumber_present) {
			    ...
			    {
				LONG_LONG value = _tempa->value.u.sgsnPDPRecord.recordSequenceNumber;
			...
			if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_recordExtensions_present) {
			    ...
			    _p_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnPDPRecord.recordExtensions);
			}
			...
			if (_tempa->value.u.sgsnPDPRecord.bit_mask & Org_M_SGSNPDPRecord_localSequenceNumber_present) {
			    ...
			    {
				ULONG_LONG value = _tempa->value.u.sgsnPDPRecord.localSequenceNumber;
				ossPrint(_g, ULLONG_FMT, value);
			    }
			}
		...
		case 2:
			...
			_p_Org_M_IPAddress(_g, &_tempa->value.u.ggsnPDPRecord.ggsnAddress);
			ossPrint(_g, ",");
			_oss_indent(_g, 0);
			ossPrint(_g, "chargingID ");
			{
			...
			if (_tempa->value.u.ggsnPDPRecord.sgsnAddress) {
				...
				_temp1b = _temp1a->next;
				_oss_indent(_g, 0);
				_p_Org_M_IPAddress(_g, &_temp1a->value);
				_temp1a = _temp1b;
				if (_temp1a)
				    ossPrint(_g, ",");
			    }
			...
			_oss_indent(_g, 0);
			ossPrint(_g, "servedPDPAddress ");
			_p_Org_M_PDPAddress(_g, &_tempa->value.u.ggsnPDPRecord.servedPDPAddress);
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_remotePDPAddress_present) {
			    ossPrint(_g, ",");
			    _oss_indent(_g, 0);
				...
				while (_temp1a) {
				    _temp1b = _temp1a->next;
				    _oss_indent(_g, 0);
				    _p_Org_M_PDPAddress(_g, &_temp1a->value);
				    _temp1a = _temp1b;
				    if (_temp1a)
					ossPrint(_g, ",");
				}
			...
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_diagnostics_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "diagnostics ");
			    _p_Org_M_Diagnostics(_g, &_tempa->value.u.ggsnPDPRecord.diagnostics);
			}
			...
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordSequenceNumber_present) {
			    ...
			    ossPrint(_g, "recordSequenceNumber ");
			    {
				LONG_LONG value = _tempa->value.u.ggsnPDPRecord.recordSequenceNumber;
			...
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_recordExtensions_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "recordExtensions ");
			    _p_Org_M_ManagementExtensions(_g, &_tempa->value.u.ggsnPDPRecord.recordExtensions);
			}
			...
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_GGSNPDPRecord_localSequenceNumber_present) {
			    ...
			    ossPrint(_g, "localSequenceNumber ");
			    {
				ULONG_LONG value = _tempa->value.u.ggsnPDPRecord.localSequenceNumber;
				ossPrint(_g, ULLONG_FMT, value);
			    }
			}
			...
			if (_tempa->value.u.ggsnPDPRecord.bit_mask & Org_M_sgsnPLMNIdentifier_present) {
			    ...
			    _oss_prt_oct(_g, _tempa->value.u.ggsnPDPRecord.sgsnPLMNIdentifier.value, _tempa->value.u.ggsnPDPRecord.sgsnPLMNIdentifier.length);
			}
		...
		case 3:
			...
			_oss_indent(_g, 0);
			ossPrint(_g, "sgsnAddress ");
			_p_Org_M_IPAddress(_g, &_tempa->value.u.sgsnMMRecord.sgsnAddress);
			if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_msNetworkCapability_present) {
			    ossPrint(_g, ",");
			    _oss_indent(_g, 0);
			    ossPrint(_g, "msNetworkCapability ");
			...
			if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_diagnostics_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "diagnostics ");
			    _p_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnMMRecord.diagnostics);
			}
			...
			if (_tempa->value.u.sgsnMMRecord.bit_mask & Org_M_SGSNMMRecord_recordExtensions_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "recordExtensions ");
			    _p_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnMMRecord.recordExtensions);
			}
		...
		case 4:
			...
			if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_smsResult_present) {
			    ...
			    _p_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnSMORecord.smsResult);
			}
			...
			if (_tempa->value.u.sgsnSMORecord.bit_mask & Org_M_SGSNSMORecord_recordExtensions_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "recordExtensions ");
			    _p_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnSMORecord.recordExtensions);
			}
		...
		case 5:
			...
			if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_smsResult_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "smsResult ");
			    _p_Org_M_Diagnostics(_g, &_tempa->value.u.sgsnSMTRecord.smsResult);
			}
			...
			if (_tempa->value.u.sgsnSMTRecord.bit_mask & Org_M_SGSNSMTRecord_recordExtensions_present) {
			    ...
			    _oss_indent(_g, 0);
			    ossPrint(_g, "recordExtensions ");
			    _p_Org_M_ManagementExtensions(_g, &_tempa->value.u.sgsnSMTRecord.recordExtensions);
			}
...
/* Entry points */
static const _entry_point_struct _entry_points = {_ossinit_CDRF_R98_Org_M, _emCDRF_R98, _dmCDRF_R98, _fmCDRF_R98, 16,
 NULL, NULL, 0, 0, NULL
#ifdef OSSPRINT
, _pmCDRF_R98
#endif
...
static void _oss_post_init(struct ossGlobal *world) {
    static const unsigned char _oss_typeinfo[] = {
        0x00, 0x7b, 0x33, 0xb2, 0x38, 0xea, 0x9a, 0x2f, 0xda, 0x1c,
        0xbb, 0x37, 0xda, 0x01, 0xbb, 0xfd, 0x5f, 0xc1, 0x30, 0x2e,
        0x5f, 0x23, 0x5b, 0xf1, 0xcc, 0x35, 0x12, 0x97, 0xd4, 0x45,
        0xc6, 0xc0, 0xff, 0x7b, 0x99, 0x96, 0x17, 0xaa, 0xda, 0x7f,
        0x69, 0xb0, 0xc2, 0xe1, 0xa0, 0x35, 0x75, 0x0a, 0x8b, 0xa8,
        0x74, 0x9d, 0xeb, 0xed, 0x1e, 0xbd, 0xaf, 0x4e, 0x40, 0x8c,
        0x16, 0xa7, 0x4d, 0xcc, 0x0c, 0x1d, 0xc5, 0x4d, 0x31, 0x06,
        0x02, 0x36, 0xf7, 0xdf, 0x78, 0x31, 0x77, 0x82, 0x89, 0xee,
        0xd6, 0xf8, 0xcc, 0xb7, 0x60, 0x93, 0xcb, 0xaa, 0x29, 0xf0,
        0x84, 0xc1, 0x4c, 0xaa, 0xb1, 0x2a, 0x0b, 0x48, 0x78, 0x91,
        0x19, 0xd9, 0x5f, 0xe0, 0x86, 0x37, 0xe0, 0x47, 0xe9, 0x9a,
        0x9b, 0xc2, 0x23, 0x56, 0xd8, 0x7e, 0x3b, 0x5b, 0x97, 0xd1,
        0x35, 0x92, 0xb4, 0xe6, 0x49
    };
...
void *CDRF_R98_Org_M = (void *)&_entry_points;
