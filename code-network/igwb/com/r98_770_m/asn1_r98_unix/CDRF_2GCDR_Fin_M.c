...
/* Created: Fri Dec 19 10:58:54 2003 */
...
static void _ossinit_CDRF_R98_Fin_M(struct ossGlobal *world) {
...
static const _Context_Id _context_id[] = {
    ...
    {"Fin_M_sgsnPLMNIdentifier", "PLMN-Id", _octetstring_type},
...

	{
		...
		_temp = (struct Fin_M__seqof6 *) _oss_enc_pop(_g);
		{
...

			{
			    ...
			    if (_temp->value.u.ggsnPDPRecord.bit_mask & Fin_M_sgsnPLMNIdentifier_present) {
			...
			case 0x1: {
				...
				while (TRUE) {
					...
					case 0x1B: {
					    ...
					    if (_temp->value.u.ggsnPDPRecord.bit_mask & Fin_M_sgsnPLMNIdentifier_present) _oss_dec_error(_g, TRUE, _field_repeat, 0L);	/* We already decoded this. */
					    _temp->value.u.ggsnPDPRecord.bit_mask |= Fin_M_sgsnPLMNIdentifier_present;
					    _oss_c->_tag_decoded = FALSE;
					    _data_length = _oss_dec_length(_g, _in_pos, _buf_len);
...
static int _fFin_M_BSRecord(struct ossGlobal *_g, void *_data)
{
	...
	while (_tempa) {
		...
		if (_tempa->value.u.ggsnPDPRecord.bit_mask & Fin_M_sgsnPLMNIdentifier_present) {
		}
...
/* Entry points */
static const _entry_point_struct _entry_points = {_ossinit_CDRF_R98_Fin_M, _emCDRF_R98, _dmCDRF_R98, _fmCDRF_R98, 16,
 NULL, NULL, 0, 0, NULL
#ifdef OSSPRINT
, _pmCDRF_R98
#endif
...
static void _oss_post_init(struct ossGlobal *world) {
    static const unsigned char _oss_typeinfo[] = {
        0x00, 0x7c, 0x33, 0x33, 0x48, 0x72, 0x62, 0xae, 0xaa, 0x84,
        0x43, 0xb6, 0xaa, 0x99, 0x43, 0xf9, 0x04, 0xb4, 0xe9, 0x9d,
        0xd0, 0xc1, 0x32, 0x0c, 0x91, 0x7f, 0x52, 0xc8, 0xac, 0x2a,
        0xd1, 0x71, 0x23, 0x8c, 0x06, 0x9a, 0x37, 0x54, 0x4f, 0x32,
        0xfa, 0xdd, 0x9d, 0x3a, 0xa7, 0x15, 0xf1, 0xef, 0x53, 0x4b,
        0xb3, 0xdf, 0x43, 0xbb, 0x52, 0x1f, 0x28, 0x93, 0x54, 0x94,
        0x27, 0x7e, 0xeb, 0x76, 0xf5, 0xae, 0xad, 0x9e, 0x08, 0xc9,
        0x2e, 0x2c, 0xad, 0x16, 0x5c, 0x51, 0xa3, 0x1f, 0x14, 0xc4,
        0x68, 0x9a, 0xfc, 0x10, 0x0a, 0xb1, 0x68, 0x68, 0x7e, 0xf3,
        0x50, 0x1f, 0x80, 0xdc, 0xc8, 0xc5, 0xaa, 0xe1, 0x44, 0xd1,
        0x79, 0x42, 0x34, 0x38, 0x6f, 0xa8, 0x23, 0x8b, 0x44, 0xb9,
        0x22, 0x9f, 0x99, 0x56, 0x8f, 0x6b, 0xf1, 0xd9, 0x32, 0x6a,
        0x8c, 0x7f, 0x79, 0xdc, 0x84, 0x6a
    };
...
void *CDRF_R98_Fin_M = (void *)&_entry_points;
