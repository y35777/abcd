...
/* Created: Fri Dec 19 10:59:37 2003 */
...
#ifndef OSS_CDRF_R98_Org_M
#define OSS_CDRF_R98_Org_M
...
#       define      Org_M_significance_present 0x80
    ...
    struct Org_M__octet8 information;
...
#       define      Org_M_sgsnPLMNIdentifier_present 0x0020
#       define      Org_M_GGSNPDPRecord_servedMSISDN_present 0x0010
    Org_M_CallEventRecordType recordType;
    Org_M_NetworkInitiatedPDPContext networkInitiation;  /* optional; set in
                                   * bit_mask
    ...
    Org_M_APNSelectionMode apnSelectionMode;  /* optional; set in bit_mask
                              ...
                              * present */
    Org_M_PLMN_Id   sgsnPLMNIdentifier;  /* optional; set in bit_mask
                                          * Org_M_sgsnPLMNIdentifier_present if
                                          * present */
    Org_M_MSISDN    servedMSISDN;  /* optional; set in bit_mask
...
extern void *CDRF_R98_Org_M;    /* encoder-decoder control table */
#ifdef __cplusplus
}	/* extern "C" */
#endif /* __cplusplus */
#endif /* OSS_CDRF_R98_Org_M */
