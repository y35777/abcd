...
#include "CDRF_3GPPR4_Org.h"
#include "../../include/export_dll.h"

/******************************************************
* 函数名:   DeCodeR4Bill_ini_mt
* 作者:    
* 日期:    01-10-8
* 描述:    
* 输入: 
                      ...
                      int nBufLen)    /* 缓冲区的长度 */
{
    ...
    int pdu = R4_Org_CallEventRecord_PDU;
                                         ...
                                         /* 并返回编码结果的长度 (in,out) */
{
    ...
    int nErr = 0;
    if(nErr = ossEncode(world, R4_Org_CallEventRecord_PDU,(void*)pVal,
        &encodedData))
    {
